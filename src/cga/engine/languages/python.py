...
from cga.utils.tree_sitter_manager import execute_query
        ...
        try:
            if is_notebook:
                try:
                    ...
                    raise ImportError(
                        "Parsing .ipynb files requires optional dependencies "
                        "nbformat and nbconvert. Install them to index notebooks."
                    ) from e
        ...
        try:
            ...
            if path.suffix == '.ipynb':
                try:
                    ...
                    raise ImportError(
                        "Pre-scanning .ipynb files requires optional dependencies "
                        "nbformat and nbconvert. Install them to index notebooks."
                    ) from e
